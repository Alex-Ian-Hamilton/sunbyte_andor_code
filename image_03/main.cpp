 ...
 *         2560 x 2160 (5.5 Megapixel) for the Andor Zyla 5.5
 */
int updateImageSize()
{
  // 
    ...
    if (errorOk(i_err, "AT_Command 'Acquisition Start'"))
    {
      ...
      if (errorOk(i_err, "AT_WaitBuffer"))
      {
        ...
        else
        {
          ...
          printf("i64_aoiWidth %lld\n", i64_aoiWidth);
          printf("i64_aoiHeight %lld\n", i64_aoiHeight);
          printf("i64_aoiStride %lld\n", i64_aoiStride);
          printf("i64_sizeInBytes %lld\n\n", i64_sizeInBytes);
          //std::cout << "i64_total = " << i64_total << std::endl;
          //std::cout << "_i64_width = " << _i64_width << std::endl;
          //std::cout << "_i64_height = " << _i64_height << std::endl;
          ...
          //if (!outfile) throw FormattedException("%s:%d Failed to open output file", __FILE__, __LINE__);
          ...
          cinfo.image_width      = i64_aoiWidth;
          cinfo.image_height     = i64_aoiHeight;
